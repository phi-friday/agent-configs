...
description: "Use when the user has a vague idea, unclear problem, unfamiliar code area, option comparison, scope or architecture question, PRD/spec request, or wants to think before implementing. 막연한 아이디어, 불명확한 문제, 낯선 코드, 선택지 비교, 범위/아키텍처 질문, PRD/spec, 구현 전 사고가 필요할 때."
---
