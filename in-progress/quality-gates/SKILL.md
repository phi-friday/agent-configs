---
name: quality-gates
description: "Use before claiming work is done, fixed, passing, ready, reviewed, mergeable, or before committing, opening a PR, closing a bug, accepting subagent work, or reporting success. 완료, 수정됨, 통과, 준비됨, 리뷰됨, 병합가능, 커밋, PR, 버그 종료, 서브에이전트 결과 수락, 성공 보고 전."
---
