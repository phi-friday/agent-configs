...
description: "기능, 버그수정, 리팩터링, 동작변경, 공개 API, CLI, UI, 회귀 수정 구현 전에. Use when implementing any feature, bug fix, refactor, behavior change, public API, CLI flow, UI behavior, or regression fix before writing production code."
---
